...
namespace Aref.Infra.Data.Repositories.Generics;

public class EfRepository<TEntity, TKey> : IEfRepository<TEntity, TKey>
    where TEntity : BaseEntity<TKey>
    where TKey : IEquatable<TKey>
{
    protected readonly ArefContext Context;
    protected readonly DbSet<TEntity> DbSet;

    protected EfRepository(ArefContext context)
    {
        Context = context;
...
public class EfRepository<TEntity>(ArefContext context)
