...
namespace Aref.Application.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        public static string ToStringShamsiDate(this DateTime dt)
        {
            ...
            {
                case 1:
                    strMonthName = "Farvardin";
                    break;
                case 2:
                    strMonthName = "Ordibehesht";
                    break;
                case 3:
                    strMonthName = "Khordad";
                    break;
                case 4:
                    strMonthName = "Tir";
                    break;
            ...
            switch (enDayOfWeek)
            {
                ...
                case DayOfWeek.Saturday:
                    ...
                    break;
                case DayOfWeek.Sunday:
                    strDayName = "YekShanbe";
                    break;
                case DayOfWeek.Thursday:
                    strDayName = "PanjShanbe";
                    break;
                case DayOfWeek.Tuesday:
                    strDayName = "SeShanbe";
                    break;
                case DayOfWeek.Wednesday:
                    strDayName = "ChaharShanbe";
                    break;
                default:
                    strDayName = "";
                    break;
