...
public class BaseController : Controller
{
    ...
    public void ShowSweetAlertSuccessMessage() =>
        TempData[SweetAlertSuccessMessage] = "Operation completed successfully";
    ...
    public void ShowSweetAlertErrorMessage() =>
        TempData[SweetAlertErrorMessage] = "Operation failed";
    ...
    public void ShowToasterSuccessMessage() =>
        TempData[ToasterSuccessMessage] = "Operation completed successfully";
    ...
    public void ShowToasterErrorMessage() =>
        TempData[ToasterErrorMessage] = "Operation failed";
