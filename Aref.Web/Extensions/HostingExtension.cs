...
using Aref.Web.Configurations;
using Aref.Web.Middlewares;
using Aref.Infra.IOC;
...
public static class HostingExtension
{
    ...
    public static WebApplication ConfigServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddDbContext<ArefContext>(options => { options.UseSqlServer(builder.Configuration.GetConnectionString("ArefConnectionString")); });
